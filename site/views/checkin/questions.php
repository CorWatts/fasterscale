...
foreach($options as $option) {
    ...
    $restructured_options[$option['category_id']][$option['option_id']] = $option['option_name'];
}
?>
...
foreach($categories as $category_id => $category_name) {
    print $form->field($model, "option_id{$category_id}")->radioList($restructured_options[$category_id], ['class' => "btn-group", 'data-toggle' => 'buttons', 'item'=>"radioItemTemplate"]);
