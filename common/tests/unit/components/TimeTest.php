...
class TimeTest extends \Codeception\Test\Unit
{
    ...
    {
        $this->specify(
            'getLocalTime should function correctly',
            function () {
    ...
    {
        $this->specify(
            'convertLocalToUTC should function correctly',
            function () {
    ...
    {
        $this->specify(
            'convertUTCToLocal should function correctly',
            function () {
                $utc_tz = (new DateTime("now"))->format("Y-m-d H:i:s");
    ...
    {
        $this->specify(
            'getLocalDate should function correctly',
            function () {
    ...
    {
        $this->specify(
            'alterLocalDate should function correctly',
            function () {
    ...
    {
        $this->specify(
            'getUTCBookends should function correctly',
            function () {
    ...
    public function testParse()
    {
        ...
        $this->specify(
            'should still work fine with other timezones',
            function () {
