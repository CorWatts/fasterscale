...
class LoginFormTest extends \Codeception\Test\Unit
{
    ...
    {
        $this->specify(
            'getUser shougd function correctly',
            function () {
    ...
    {
        $this->specify(
            'validatePassword should function correctly',
            function () {
    ...
    public function testLogin()
    {
        ...
        $this->specify(
            'login should fail if account is not verified',
            function () {
        ...
        $this->specify(
            'login should fail if credentials are not valid',
            function () {
                $this->user = $this->mockUser(['validatePassword' => false]);
                $this->form = $this->mockForm($this->user);
                $this->form->email = 'hunter2@hunter2.com';
