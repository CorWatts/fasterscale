...
class UserBehaviorTest extends \Codeception\Test\Unit
{
    ...
    {
        // pull in test data
        $data = include __DIR__ . '/../data/checkinData.php';
    ...
    public function testAttributeLabels()
    {
        expect(
            'attributeLabels',
            $this->assertEquals(
                $this->user_behavior->attributelabels(),
                [
                'id'        => 'ID',
                'date'      => 'Date',
                'user_id'   => 'User ID',
    ...
    {
        expect(
            'decorate should add Behavior data to an array of UserBehaviors',
            $this->assertEquals(
    ...
    public function testGetBehaviorsByCategory()
    {
        ...
        expect(
            'getBehaviorsByCategory to return the empty array if the user has not logged any behaviors',
            $this->assertEquals(
                [
                1 => [
                'name' => 'Restoration',
    ...
    public function testGetCheckinBreakdown()
    {
        ...
        $bhvrs = include __DIR__ . '/../data/behaviorsWithCounts.php';
